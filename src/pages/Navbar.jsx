        ...
        <div className="px-28 mx-auto">
          <div className="flex items-center justify-between h-19">
            ...
            <div className="hidden md:block ">
              <div className="flex">
                <button
                  className="flex-shrink-0 m-1.5 w-7.5 ml-1 h-7.5 text-base font-semibold text-black rounded-4 border-black border shadow-md   "
                  type="submit"
                >
                ...
                <button
                  className="flex-shrink-0 m-1.5 text-base font-semibold text-black rounded-4 border-black border shadow-md   "
                  type="submit"
                >
                  <a href="/launch_token">
                ...
                <button
                  className="flex-shrink-0 ml-1.5 my-1.5 text-base bg-slate-350 font-semibold text-black rounded-s-4  border-blue-500 border shadow-md   "
                  type="submit"
                >
